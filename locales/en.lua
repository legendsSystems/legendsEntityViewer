Locales = {}
Locales["en"] = {
	["players_freeze"] = "Player Freeze Activated/Deactivated",
	["players_revive_all"] = "Players have been revived",
	["players_wrong"] = "Please Spcify a Player ID",
	["players_nearby"] = "There is no one nearby",
	["players_perms"] = "Insufficent Perms",
	["players_froze"] = "SUCCESS",
	["heal_help"] = "Heal a player, or yourself - restores thirst, hunger and health.",
...
local Translations = {
	...
	info = {
		...
		["entity_view_title"] = "Entity Data Gatherer",
		["entity_freeaim_delete"] = "Delete Entity",
		["entity_freeaim_freeze"] = "Freeze Entity",
		["entity_freeaim_copy"] = "Copy Entity Vector3",
		["entity_freeaim_copy2"] = "Copy Entity Vector4",
		["entity_freeaim_copy3"] = "Copy Entity Hash",
		["entity_freeaim_copy4"] = "Copy Entity ModelName",
		["entity_freeaim_exit"] = "Close",
	...
	commands = {
		...
		["set_player_foot_speed"] = "Set your run speed"
	},
	command = {
		tp = {
